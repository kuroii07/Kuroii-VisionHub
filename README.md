...
- 灵感中心
  ...
  - 图片收藏 Gallery V2 支持搜索、批量导入、视图切换、颜色 / 形状 / 格式 / 评分筛选和一键清空筛选
...
本仓库当前处在“平台接入 + 作品画廊 V2 + 图生图工作台 + 灵感中心 V2”阶段：
...
- 灵感中心 V2 已完成图片收藏 Gallery 第一轮，支持批量导入、搜索筛选、颜色 / 形状 / 格式 / 评分过滤和评分持久化。
...
- ~~`0.2.8` 灵感中心 V2~~
  - 状态：已完成 Gallery V2 第一轮并发布；后续网站预设、相似风格聚类和真实视觉模型反推 Prompt 继续归入灵感中心增强计划。
  - ~~图片收藏改造为 Gallery 视图，支持搜索、筛选默认展开、批量导入、视图切换和详情抽屉。~~
  - ~~筛选栏参考作品画廊补齐颜色、形状、格式、评分和清空筛选。~~
